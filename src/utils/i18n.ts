	...
	private getDefaultTranslations(): Translations {
		return {
			...
			settings: {
				...
				naver_blog_subscriptions: 'Naver Blog Subscriptions',
				add_blog_id: 'Add Naver Blog ID',
				add_blog_id_desc: 'Enter a Naver blog ID to subscribe',
				// Brunch subscriptions
				brunch_subscriptions: 'Brunch Subscriptions',
				add_brunch_author: 'Add Brunch Author',
				add_brunch_author_desc: 'Enter a Brunch author username (e.g., @username)',
				brunch_author_placeholder: '@username',
				no_subscribed_brunch: 'No subscribed Brunch authors',
				blog_id_placeholder: 'Blog ID or URL (e.g., myblog or https://blog.naver.com/myblog)',
				add_button: 'Add',
			...
			notices: {
				...
				invalid_blog_id: 'Invalid blog ID or URL. Enter a valid blog ID or Naver blog URL.',
				fetching_profile: 'Fetching blog profile...',
	...
	private getKoreanTranslations(): Translations {
		return {
			...
			settings: {
				...
				naver_blog_subscriptions: '네이버 블로그 구독',
				add_blog_id: '네이버 블로그 ID 추가',
				add_blog_id_desc: '구독할 네이버 블로그 ID를 입력하세요',
				// Brunch subscriptions
				brunch_subscriptions: '브런치 구독',
				add_brunch_author: '브런치 작가 추가',
				add_brunch_author_desc: '브런치 작가 사용자명을 입력하세요 (예: @username)',
				brunch_author_placeholder: '@username',
				no_subscribed_brunch: '구독한 브런치 작가가 없습니다',
				blog_id_placeholder: '블로그 ID 또는 URL (예: myblog 또는 https://blog.naver.com/myblog)',
				add_button: '추가',
				remove_button: '제거',
				sync_button: '동기화',
			...
			notices: {
				...
				invalid_blog_id: '잘못된 블로그 ID 또는 URL입니다. 유효한 블로그 ID 또는 네이버 블로그 URL을 입력하세요.',
				fetching_profile: '블로그 프로필 가져오는 중...',
